...
|------|--------|----------------------------|
| A. Данные | 1–7 | Граф трёх систем двух городов лежит в БД, у объектов есть пешие плечи до станций |
| B. Движок и контракт | 8–11 | Маршрут считается, контракт описан, досье показывает метро-ногу |
...
Этапы A→B→C и A→B→D→E последовательны. Задачи 14–15 не зависят от 12–13 и могут идти параллельно.
