 ...
 * баров. Синий освобождён намеренно — рядом живёт акцент интерфейса
 * (--accent: alias на --evidence, #14493C), которым помечены НАШИ объекты, и
 * путать их с городскими точками нельзя.
 */
