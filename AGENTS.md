...
**Вся новая информация по проекту, появившаяся или обнаруженная в ходе любой задачи,
обязана сразу заноситься в эту базу знаний.** Это относится к исследованиям, промптам,
сырым результатам ИИ, источникам, выводам, гипотезам, сведениям о рынке, целевой
аудитории и конкурентах, продуктовым и бизнес-решениям, финансовым расчётам, обратной
связи, договорённостям, отчётам и важному техническому контексту, влияющему на проект.
...
Перед завершением каждой задачи по Habitus нужно проверить, появилась ли новая
проектная информация, и при необходимости обновить базу. Информация, оставшаяся
только в чате, устном обсуждении, истории ИИ, терминале или отдельном внешнем файле,
не считается зафиксированным знанием проекта. Если база недоступна для записи, об
этом нужно явно сообщить пользователю и перечислить, что осталось вне базы.
