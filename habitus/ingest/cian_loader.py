...
# Специфичные для Циана поля (zhk, metro, building_material, deadline) переносим
# в source_extra для кроссплатформенной совместимости: у следующего источника
# могут быть названия иные, а downstream-обработчики работают с единым форматом.
